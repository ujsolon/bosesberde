...
import { Upload, Send, FileText, Image } from 'lucide-react';
...
function ChatInterface() {
  ...
  return (
    <>
      ...
      <SidebarInset>
        {/* Top Controls - Fixed */}
        <div className="sticky top-0 z-10 flex items-center justify-between p-4 bg-background border-b border-slate-200">
        ...
        <form onSubmit={async (e) => {
          ...
          setSelectedFiles([]);
        }} className="mx-auto px-4 bg-background pb-4 md:pb-6 w-full md:max-w-3xl">
          <div className="flex items-center gap-2">
            <Input
              type="file"
            ...
            <Textarea
              ...
              className="flex-1 min-h-[48px] max-h-32 rounded-xl border-slate-200 focus:border-blue-500 focus:ring-blue-500/20 resize-none py-3 px-4 text-base leading-6 overflow-y-auto"
              disabled={isTyping}
              rows={1}
